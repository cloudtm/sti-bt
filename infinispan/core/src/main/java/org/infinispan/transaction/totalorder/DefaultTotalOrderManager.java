 ...
 * @since 5.3
 */
public class DefaultTotalOrderManager implements TotalOrderManager {

   private static final Log log = LogFactory.getLog(DefaultTotalOrderManager.class);
   /**
   ...
   public DefaultTotalOrderManager() {
    ...
    */
   @Override
   public final void ensureOrder(TotalOrderRemoteTransactionState state, Object[][] keysWriteAndRead)
      ...
      if (keysWriteAndRead == null) { //clear state
         ...
         for (Object key : keysWriteAndRead[0]) {
