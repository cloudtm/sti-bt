...
BENC_DEFAULT="-distributed -n $NUMBER -r $COUNT -time 60000 -ro $READONLY -t $THREAD_MIGRATION -repl $REPLICATION_DEGREES -l $COLOCATION -g $GHOST_READS -i $INTRA_NODE_CONC -b $LOWER_BOUND"
