...
public class District implements Serializable, DomainObject {
   ...
   public District(CacheWrapper wrapper, int nodeIndex, long d_w_id, long d_id, String d_name, String d_street1, String d_street2, String d_city, String d_state, String d_zip, double d_tax, double d_ytd, long d_next_o_id) {
      this.d_w_id = d_w_id;
      this.d_id = d_id;
      this.d_name = d_name;
      ...
      this.d_zip = d_zip;
      this.d_tax = d_tax;
//      setD_ytd(wrapper, nodeIndex, d_ytd);
      this.d_ytd = d_ytd;
   ...
   public Double getD_ytd() {
       return this.d_ytd;
      // return TpccTools.get(wrapper, wrapper.createKey(getKeyD_ytd(), nodeIndex));
   }
   ...
   public void setD_ytd(double d_ytd) {
       this.d_ytd = d_ytd;
       //TpccTools.put(wrapper, wrapper.createKey(getKeyD_ytd(), nodeIndex), d_ytd);
   }

//   public void incD_ytd(CacheWrapper wrapper, int nodeIndex, double inc) {
//       LocatedKey key = wrapper.createKey(getKeyD_ytd(), nodeIndex);
//       double newValue = ((Double) wrapper.getDelayed(key)) + inc;
//       wrapper.putDelayed(key, newValue);
//   }
   
   public String getKeyD_ytd() {
       return this.getKey() + ":d_ytd";
   }
